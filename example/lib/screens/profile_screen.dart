...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      ...
      setState(() {
        _error = 'Authentication required: ${e.message}\n\nPlease login to view your profile.';
      });
              ...
              ? Center(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          _error!.contains('Authentication') || _error!.contains('login')
                              ? Icons.lock_outline
                              : Icons.error_outline,
                          size: 64,
                          color: Colors.red,
            ...
            children: [
              ...
              _buildInfoRow(
                ...
                _customer!.isSubscribed != null
                    ? (_customer!.isSubscribed! ? 'Subscribed' : 'Not Subscribed')
                    : null,
              ),
            ],
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                if (address.street.isNotEmpty) ...[
                  ...address.street.map((line) => Padding(
                ...
                Row(
                  children: [
                    ...
                    if (address.city != null && address.region?.region != null)
                      Text(
                        ', ',
                        style: const TextStyle(fontSize: 14),
                      ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    if (address.defaultShipping == true ||
                      ...
                      Tooltip(
                        message: address.defaultShipping == true &&
                                address.defaultBilling == true
